...
import { getAllCustomers, createCustomer, updateCustomer } from '../api/Customer';
  ...
  callBack = (key, data) => {
    switch (key) {
      ...
      case 'DEL_CART':
        ...
        break;
      case 'BUY_PRODUCTS':
if(data.user.name !== '' && data.user.name != undefined  && data.user.phone !== ''&& data.user.phone != undefined && data.user.address !== ''&& data.user.address != undefined) {
   if (this.props.store.user != '') {
        ...
        let dataOrder = {
          ...
          user: data.user,
          idUser: this.props.store.user != '' ? this.props.store.user.id : ''
        };
