    ...
    this.props.store.getCategoriesAPI(res => {
      ...
      this.props.store.getAllProductsAPI(res => {
        for (let index = 0; index < this.props.store.dataProducts.length; index++) {
          ...
          if (element.category == this.data[0].query && this.data[0].data.length < 11) {
            this.data[0].data.push(element);
          } else if (element.category == this.data[1].query && this.data[1].data.length < 11) {
            this.data[1].data.push(element);
          } else if (element.category == this.data[2].query && this.data[2].data.length < 11) {
