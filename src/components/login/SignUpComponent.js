      ...
      return (
        <p>
          *Địa chỉ email này đã từng được tạo.
          <Link route="/log-in">
            <span style={{ color: '#20a286', display: 'inline', cursor: 'pointer' }}>
              Đăng nhập?{' '}
            </span>
          </Link>
          ...
          <div className="col-lg-8 col-md-10 col-12 px-0">
            ...
            <div id="login-view" className="login pad-login">
              <div className="head">
                ...
                <p>
                  <button onClick={this.loginFBHRC} className="fb font mr-md-5 mr-1">
              ...
              <div className="another row justify-content-center">
                ...
                <div className="col-12 pb-md-0 pb-4">
                  <p className="txt-note font">Mật khẩu phải có từ 8 -12 ký tự .</p>
                  <button onClick={this.signup} className="btn-login btn-login-res">
                    Đăng Ký
                  </button>
                  Bạn đã có tài khoản?
