          ...
          <div className="col-xl-6 col-lg-8 col-md-10 col-12 px-0">
            <div className="login pad-login">
              <div className="head">
                ...
                <p>
                  <button className="fb font mr-md-5 mr-1" onClick={this.loginFBHRC}>
              ...
              <div className="another px-sm-5 px-3">
                ...
                {this.props.load ? <div id="loadPost" class="loadPost" /> : null}
                <button
                  className="btn-login btn-login-res"
                  onClick={this.props.callBack('LogIn', this.state)}
                >
                  ĐĂng Nhập
                </button>
              </div>
